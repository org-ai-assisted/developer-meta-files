...
## in agents/pre-push-checklist.md "Static
...
check_comments_audit() {
   ...
   if [ -n "${out}" ] && ! printf '%s\n' "${out}" | grep --quiet -- '0 candidate findings'; then
